...
var S = {
  init: function () {
    ...
    var t= '';
    var deadline = new Date("Aug 18, 2021 09:00:00").getTime();
    function checktime(){
      ...
      var x = setInterval(function() { 
        ...
        if(secondText.indexOf('00s') > 1){
          S.UI.simulate(timeText);
        }
        mainInput.value= secondText;
            if (t < 0) { 
              document.body.classList.add('body--end');
              document.querySelector('.changeatend').innerHTML = 'Thank you all for the hardwork, dedication and initiative.';
              document.querySelector('.changeatendfooter').innerHTML = 'Far and away the best prize that life offers is the chance to work hard at work worth doing.';
                clearInterval(x); 
                S.UI.simulate('TIME UP');
